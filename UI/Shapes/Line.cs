...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeLine"/>.
    /// </summary>
    [Register(typeof(INativeLine))]
    public class Line : ContentControl, INativeLine
    {
        /// <summary>
        ...
        public Line()
        {
            ...
            Content = Element = new global::Windows.UI.Xaml.Shapes.Line();
