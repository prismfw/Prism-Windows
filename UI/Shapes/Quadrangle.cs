...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeQuadrangle"/>.
    /// </summary>
    [Register(typeof(INativeQuadrangle))]
    public class Quadrangle : ContentControl, INativeQuadrangle
    {
        /// <summary>
        ...
        {
            get { return Element.RadiusX; }
            set
            {
                if (value != Element.RadiusX)
                {
                    Element.RadiusX = value;
        ...
        {
            get { return Element.RadiusY; }
            set
            {
                if (value != Element.RadiusY)
                {
                    Element.RadiusY = value;
        ...
        /// </summary>
        protected global::Windows.UI.Xaml.Shapes.Rectangle Element { get; }
        ...
        public Quadrangle()
        {
            ...
            Content = Element = new global::Windows.UI.Xaml.Shapes.Rectangle();
