...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeSlider"/>.
    /// </summary>
    [Register(typeof(INativeSlider))]
    public class Slider : global::Windows.UI.Xaml.Controls.Slider, INativeSlider
    {
        /// <summary>
        ...
        {
            get { return SnapsTo == SliderSnapsTo.Ticks; }
            set
            {
                if (value != IsSnapToStepEnabled)
                {
                    SnapsTo = value ? SliderSnapsTo.Ticks : SliderSnapsTo.StepValues;
        ...
        public Slider()
        {
            ...
            base.ValueChanged += (o, e) =>
            {
                ...
                ValueChanged(this, new ValueChangedEventArgs<double>(e.OldValue, e.NewValue));
            };
        }
