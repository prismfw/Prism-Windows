...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeButton"/>.
    /// </summary>
    [Register(typeof(INativeButton))]
    public class Button : global::Windows.UI.Xaml.Controls.Button, INativeButton
    {
        /// <summary>
            ...
            set
            {
                if (value != areAnimationsEnabled)
                {
                    ...
                    if (areAnimationsEnabled)
                    {
                        ...
                        contentPanel.Transitions = panelTransitions;
                        contentPanel.ChildrenTransitions = panelChildrenTransitions;
                        textBlock.Transitions = textBlockTransitions;
                        image.Transitions = imageTransitions;
                    }
                    else
                    {
                        transitions = Transitions;
                        panelTransitions = contentPanel.Transitions;
                        panelChildrenTransitions = contentPanel.ChildrenTransitions;
                        textBlockTransitions = textBlock.Transitions;
                        imageTransitions = image.Transitions;

                        Transitions = null;
                        contentPanel.Transitions = null;
                        contentPanel.ChildrenTransitions = null;
                        textBlock.Transitions = null;
        ...
        private TransitionCollection transitions, panelTransitions, panelChildrenTransitions, textBlockTransitions, imageTransitions;
                ...
                if (value != contentDirection)
                {
                    ...
                    switch (contentDirection)
                    {
                        case ContentDirection.Down:
                            contentPanel.Children.Remove(textBlock);
                            contentPanel.Children.Insert(0, textBlock);
                            contentPanel.Orientation = global::Windows.UI.Xaml.Controls.Orientation.Vertical;
                            break;
        ...
        {
            get { return base.Padding.GetThickness(); }
            set
            {
                if (value != Padding)
                {
                    base.Padding = value.GetThickness();
        ...
        private readonly global::Windows.UI.Xaml.Controls.Image image;
        ...
        public Button()
        {
            image = new global::Windows.UI.Xaml.Controls.Image()
            {
                HorizontalAlignment = global::Windows.UI.Xaml.HorizontalAlignment.Center,
                Stretch = global::Windows.UI.Xaml.Media.Stretch.None,
        ...
        protected override void OnApplyTemplate()
        {
            ...
            var border = this.GetChild<Border>(c => c.Name == "Border");
            if (border != null)
            {
                border.Margin = new global::Windows.UI.Xaml.Thickness();
            }
        }
