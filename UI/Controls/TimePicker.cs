...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeTimePicker"/>.
    /// </summary>
    [Register(typeof(INativeTimePicker))]
    public class TimePicker : global::Windows.UI.Xaml.Controls.Button, INativeTimePicker
    {
        /// <summary>
        ...
        public TimeSpan? SelectedTime
        {
            ...
            set
            {
                if (value != selectedTime)
                {
                    ...
                    flyout.Time = selectedTime.HasValue ? selectedTime.Value : DateTime.Now.TimeOfDay;
        ...
        private readonly TimePickerFlyout flyout;
        ...
        public TimePicker()
        {
            ...
            Flyout = flyout = new TimePickerFlyout() { Placement = FlyoutPlacementMode.Top };
        ...
        private void SetTitle()
        {
            ...
            {
                Content = (DateTime.Today + selectedTime.Value).ToString(timeStringFormat ?? "t");
            }
            else
            {
