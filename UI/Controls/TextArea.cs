...
{
    /// <summary>
    /// Represents a Windows implementation for an <see cref="INativeTextArea"/>.
    /// </summary>
    [Register(typeof(INativeTextArea))]
    public class TextArea : global::Windows.UI.Xaml.Controls.TextBox, INativeTextArea
    {
        /// <summary>
        ...
        public new Brush Background
        {
            ...
            set
            {
                ...
                {
                    background = value;
                    base.Background = background.GetBrush() ?? Windows.Resources.GetBrush(this, Windows.Resources.BackgroundAltHighBrushId);
        ...
        public new Brush BorderBrush
        {
            ...
            set
            {
                ...
                {
                    borderBrush = value;
                    base.BorderBrush = borderBrush.GetBrush() ?? Windows.Resources.GetBrush(this, Windows.Resources.ForegroundChromeDisabledLowBrushId);
        ...
        public Size Measure(Size constraints)
        {
            try
            {
                ...
                var minHeight = FontSize * 1.33 * minLines + 11;
                var maxHeight = FontSize * 1.33 * maxLines + 11;
                
                var size = base.MeasureOverride(constraints.GetSize()).GetSize();
                size.Height = Math.Min(Math.Max(minHeight, Math.Min(maxHeight, size.Height)), constraints.Height);
                return size;
            }
            finally
            {
